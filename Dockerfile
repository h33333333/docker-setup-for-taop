...
RUN su - postgres -c "/usr/lib/postgresql/18/bin/pg_ctl -D /tmp/pgdata -l /tmp/log start" && \
    ...
    pgloader "https://github.com/lerocha/chinook-database/blob/7f67772503d71ba90f19283c38e93923addb43fa/ChinookDatabase/DataSources/Chinook_Sqlite_AutoIncrementPKs.sqlite" pgsql://postgres@/chinook && \
    su - postgres -c "/usr/lib/postgresql/18/bin/pg_ctl -D /tmp/pgdata stop";
